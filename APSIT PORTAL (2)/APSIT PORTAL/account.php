...
<title>APSIT || TEST YOUR SKILL </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">APSIT</span></div>
...
if (@$_GET['q']==2.1) {
  ?>
  <div class="row">
    <span class="title1" style="margin-left:30%;font-size:30px;"><b>Enter College Search Details</b></span><br /><br />
...
if(@$_GET['dept']==11)
{ 
  $sql=mysqli_query($con,"SELECT score FROM score WHERE email='$email' AND quiz='Chem2' AND department='chemical'");
  $score1=mysqli_fetch_assoc($sql);
  $sql=mysqli_query($con,"SELECT score FROM score WHERE email='$email' AND quiz='Chem3' AND department='chemical'");
  ...
  <div class="card-body">
    ...
    <p class="card-text">You had good Score<br> You can Choose these branch</p>
  ...
  <div class="panel-body">
    <h5 class="card-title">Panel title</h5>
    <p class="card-text">You had passed the test <br> You can Choose these branch</p>
    <a class="card-link">Card link</a>
    <a class="card-link">Another link</a>
  </div>
</div>';
  ...
  <div class="panel-body">
    <h5 class="card-title">Panel title</h5>
    <p class="card-text">Sorry!!</br> Your result is failed</p>
    <a class="card-link">Card link</a>
    <a class="card-link">Another link</a>
  </div>
</div>';
...
if(@$_GET['dept']==12)
{ 
  $sql=mysqli_query($con,"SELECT score FROM score WHERE email='$email' AND quiz='Civil1' AND department='civil'");
  $score1=mysqli_fetch_assoc($sql);
  $sql=mysqli_query($con,"SELECT score FROM score WHERE email='$email' AND quiz='Civil2' AND department='civil'");
  $score2=mysqli_fetch_assoc($sql);
  $total=$score1||$score2;
   if($total>=80)
  {
...
if(@$_GET['dept']==13)
{ 
  $sql=mysqli_query($con,"SELECT score FROM score WHERE email='$email' AND quiz='Com1' AND department='computer'");
  $score1=mysqli_fetch_assoc($sql);
  $sql=mysqli_query($con,"SELECT score FROM score WHERE email='$email' AND quiz='Com2' AND department='computer'");
  $score2=mysqli_fetch_assoc($sql);
  $sql=mysqli_query($con,"SELECT score FROM score WHERE email='$email' AND quiz='Com3' AND department='computer'");
  $score3=mysqli_fetch_assoc($sql);
...
if(@$_GET['dept']==14)
{ 
  $sql=mysqli_query($con,"SELECT score FROM score WHERE email='$email' AND quiz='Mech1' AND department='mechanical'");
  $score1=mysqli_fetch_assoc($sql);
  $sql=mysqli_query($con,"SELECT score FROM score WHERE email='$email' AND quiz='Mech2' AND department='mechanical'");
  $score2=mysqli_fetch_assoc($sql);
  $total=$score1||$score2;
   if($total>=80)
  {
  ...
  <div class="panel-body">
    <h5 class="card-title">Panel title</h5>
    <p class="card-text">Sorry!!</br> Your result failed</p>
    <a class="card-link">Card link</a>
    <a class="card-link">Another link</a>
  </div>
</div>';
...
{ 
  ...
  <div class="card-body">
    <h5 class="card-title">Panel title</h5>
    <p class="card-text">You had good Score/n You can Choose these branch</p>
    <a class="card-link">Card link</a>
    <a class="card-link">Another link</a>
  </div>
</div>';
  ...
  <div class="panel-body">
    <h5 class="card-title">Panel title</h5>
    <p class="card-text">You had passed the test /n You can Choose these branch</p>
    <a class="card-link">Card link</a>
    <a class="card-link">Another link</a>
  </div>
</div>';
    ...
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Dhruv ,Sampada ,Amey & Rubin </a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9028606562</h4>
		<h4 style="font-family:'typo' ">dhruv200229@gmail.com</h4>
		<h4 style="font-family:'typo' ">AP Shah Institute of technology</h4></div></div>
		</p>
      </div>
